...
//wizadylan@gmail.com	apple	(admin)
//apple@apple.com		apple	(non admin)
...
<body>
    <div class="login-container">
        ...
        <p> email_____________pass_____type</p>
        <p>wizadylan@gmail.com	apple	(admin)</p>
        <p>apple@apple.com		apple	(non admin)</p>
