...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($short_description) && !empty($long_description) && !empty($open_date) && !empty($priority) && !empty($project)) {
        $stmt = $pdo->prepare("INSERT INTO iss_issues (short_description, long_description, open_date, close_date, priority, project, per_id) 
                               VALUES (:short_description, :long_description, :open_date, :close_date, :priority, :project, :per_id)");
        $stmt->execute([
